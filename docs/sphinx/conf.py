...
try:
    from sdss5-metrics import __version__
except ModuleNotFoundError:
    from sdsstools import get_package_version
    __version__ = get_package_version(__file__, 'sdss5-metrics') or 'dev'
...
project = 'sdss5-metrics'
copyright = '{0}, {1}'.format('2022', 'John Donor')
author = 'John Donor'
...
.. |sdss5-metrics_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('sdss5-metrics')
...
man_pages = [
    (master_doc, 'sdss5-metrics', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/sdss5-metrics'
